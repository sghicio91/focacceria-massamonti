...
const MENU = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 14, name:"AMY",             desc:"Mortadella I.G.P. con pistacho, crema de pistacho, stracciatella, pistacho troceado", prices:{ mediana:7.50, grande:13.00 } },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 17, name:"BURRATA TOP",   desc:"Jamón serrano italiano, rucula, crema de trufa, burrata fresca",                   prices:{ mediana:7.00, grande:12.00 } },
      { id: 18, name:"TORE TORE",     desc:"nduja de spilinga,porchetta casera,burrata fresca",                  prices:{ mediana:7.50, grande:13.00 } },
